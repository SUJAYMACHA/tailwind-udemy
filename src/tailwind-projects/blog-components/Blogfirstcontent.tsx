...
export const Blogfirstcontent = () => {
    return(
        ...
        <div className="text-[#0A2640] text-xl flex justify-center p-5">Our Blog</div>
        <div className="font-Manrope text-6xl text-[#0A2640] justify-center flex">Thoughts and Words</div>
